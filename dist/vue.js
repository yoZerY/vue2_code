(function (global, factory) {
  ...
  var id = 0; //每个属性有Dep（属性石被观察者） watcher就是观察者（属性变化就会通知 watcher）  观察者模式
  // 每个组件都有单独的watcher
